...
def project_selection():
    ...
    with st.container():
        ...
        try:
            ...
            logging.error(f"Project selection error: {e}")
            st.error("An error occurred during project selection. Please try again.")
...
def view_all_classifications():
    ...
    with st.container():
        ...
        try:
            ...
            logging.error(f"View classifications error: {e}")
            st.error("An error occurred while fetching classifications. Please try again.")
